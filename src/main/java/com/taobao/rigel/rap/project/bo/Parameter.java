...
public class Parameter implements java.io.Serializable {
    ...
    private Set<Action> actionReturnList = new HashSet<Action>(); // return-code

    public Set<Action> getActionReturnList() {
        return actionReturnList;
    }

    public void setActionReturnList(Set<Action> actionReturnList) {
        this.actionReturnList = actionReturnList;
    }
