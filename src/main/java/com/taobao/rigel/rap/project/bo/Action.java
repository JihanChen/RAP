...
public class Action implements java.io.Serializable {
    ...
    private Set<Parameter> returnCodeList = new HashSet<Parameter>(); // return-code
    ...
    public void addParameter(Parameter parameter, ParameterType parameterType) {
        if (ParameterType.REQUEST.equals(parameterType)) {
            ...
            getReturnCodeList().add(parameter);
            parameter.getActionReturnList().add(this);
        }
    }
    ...
    public Set<Parameter> getReturnCodeList() {
        return returnCodeList;
    }

    public void setReturnCodeList(Set<Parameter> returnCodeList) {
    ...
    public String toString() {
       ...
       /* return-code  begin */
        stringBuilder.append("],");
        stringBuilder.append("\"returnCodeList\":");
        stringBuilder.append("[");
        iterator = getReturnCodeListOrdered().iterator();
        while (iterator.hasNext()) {
            stringBuilder.append(iterator.next());
            if (iterator.hasNext()) {
                stringBuilder.append(",");
    ...
    /*return-code  begin */
    public List<Parameter> getReturnCodeListOrdered() {
        Set<Parameter> parameterList = getReturnCodeList();
        List<Parameter> parameterListOrdered = new ArrayList<Parameter>();
        parameterListOrdered.addAll(parameterList);
        Collections.sort(parameterListOrdered, new ParameterComparator());
        return parameterListOrdered;
