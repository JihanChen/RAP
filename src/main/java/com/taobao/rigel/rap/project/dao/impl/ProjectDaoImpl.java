...
public class ProjectDaoImpl extends HibernateDaoSupport implements ProjectDao {
                ...
                for (Action action : page.getActionList()) {
                    ...
                    for (Parameter parameter : action.getRequestParameterList()) {
                        Parameter parameterServer = projectServer
                                .findParameter(parameter.getId(), ParameterType.REQUEST);
                    ...
                    for (Parameter parameter : action
                        ...
                        Parameter parameterServer = projectServer
                                .findParameter(parameter.getId(), ParameterType.RESPONSE);
                        if (parameterServer == null) {
                            addParameter(session, action, parameter, ParameterType.RESPONSE);
                            continue;
                        }
                        parameterServer.update(parameter);
                        for (Parameter childParameter : parameter
                    ...
                    for (Parameter parameter : action
                            .getReturnCodeList()) {
                        Parameter parameterServer = projectServer
                                .findParameter(parameter.getId(), ParameterType.RETURNCODE);
                        if (parameterServer == null) {
                            addParameter(session, action, parameter,ParameterType.RETURNCODE);
                            continue;
                        }
                        parameterServer.update(parameter);
                        for (Parameter childParameter : parameter
    ...
    private void addParameter(Session session, Action action,
        ...
        action.addParameter(parameter, parameterType);
