...
public class ProjectAction extends ActionBase {
    ...
    public String create() {
        ...
        // extend add 查找产品线 项目所属产品线
        Group group = organizationMgr.getGroup(groupId);
        ProductionLine line=organizationMgr.getProductionLine(group.getProductionLineId());
        project.setCorporationId(line.getCorporationId());
        // extend add 查找产品线 项目所属产品线
